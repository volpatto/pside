...
# gfortran compiler.                                          #
# The use cases is:                                           #
#   ./compile_original_gfortran.sh test_problem               #
...
echo "+++ Initializing..."
comando="gfortran -c ../original/pside.f"; eval $comando; echo -e "\t$comando"
comando="gfortran -c ../original/psidea.f"; eval $comando; echo -e "\t$comando"
comando="gfortran -c ../original/report.f"; eval $comando; echo -e "\t$comando"
comando="gfortran -c ../original/psided.f"; eval $comando; echo -e "\t$comando"
# Building executable
echo "+++ Linking..."
