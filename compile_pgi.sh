...
if [ -z "$2" ]; then
    # Compiling modules
    echo "+++ Initializing..."
    comando="pgfortran -c ../src/pside.f"; eval $comando; echo -e "\t$comando"
    comando="pgfortran -c ../src/psidea.f"; eval $comando; echo -e "\t$comando"
    comando="pgfortran -c ../src/report.f"; eval $comando; echo -e "\t$comando"
    comando="pgfortran -c ../src/psided.f"; eval $comando; echo -e "\t$comando"
    # Building executable
    echo "+++ Linking..."
    ...
    # Compiling modules
    echo "+++ Initializing..."
    comando="pgfortran -c -fast ../src/pside.f"; eval $comando; echo -e "\t$comando"
    comando="pgfortran -c -fast ../src/psidea.f"; eval $comando; echo -e "\t$comando"
    comando="pgfortran -c -fast ../src/report.f"; eval $comando; echo -e "\t$comando"
    comando="pgfortran -c -fast ../src/psided.f"; eval $comando; echo -e "\t$comando"
    # Building executable
    echo "+++ Linking..."
